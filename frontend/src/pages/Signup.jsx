      ...
      <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            />
            {validationErrors.name && <p className="text-red-300 text-sm mt-1">{validationErrors.name}</p>}
          </div>
          <div className="mb-4">
        ...
        <p className="mt-4 text-center">
          Already have an account? <Link to="/login" className="text-white hover:text-indigo-300">Login</Link>
        </p>
      </div>
    </div>
  );
